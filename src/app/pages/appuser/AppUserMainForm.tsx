...
const AppUserMainForm = ({ appUserData }: any) => {
    ...
    try {
      ...
      if (data) {
        ...
        if (appUserData && appUserData.role) {
          const selectedList = data.filter(
            (a: any) => a.value === appUserData.role
          );
          if (selectedList.length) {
            setSelectedVerifyShops(selectedList[0].value);
          }
        ...
        const filterpublish = data.filter(
          (a: any) => a.section === "PublishType"
        );
        setPublishes(filterpublish);
        if (appUserData && appUserData.publish) {
          const selectedList = data.filter(
            (a: any) => a.value === appUserData.publish
          );
          if (selectedList.length) {
  ...
  useEffect(() => {
    if (appUserData) {
      ...
      setFormData({
        ...appUserData,
        lastLogin: appUserData.lastLogin
          ? appUserData.lastLogin.slice(0, 10)
          : "",
      });
  ...
  const validateTab1 = () => {
    ...
    if (!result.success) {
      ...
      setErrors((prevErrors) => ({
        ...
        mobileVerifiedError: fieldErrors.mobileVerified
          ? fieldErrors.mobileVerified[0]
          : "",
      }));
  ...
  const handleChange = (e: any) => {
    ...
    if (name === "name" || name === "mobile" || name === "mobileVerified")
      validateTab1();
    if (
      name === "role" ||
      name === "isActive" ||
                    ...
                    <div className="p-2">
                      <div className="grid gap-2 lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 pb-5 ">
                        <div className="flex flex-col">
                          <div className=" flex items-center">
                            <Label
                              htmlFor="name"
                              className="text-sm font-bold py-2 px-3"
                            >
                              Name
                            </Label>
                          ...
                          />
                          {errors.name && (
                            <p className="text-red-600 text-xs pb-5">
                              {errors.name}
                            </p>
                          )}
                        </div>
                      ...
                      <div className="grid gap-2 lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 pb-5 ">
                        <div className="flex flex-col">
                          ...
                          />
                          {errors.mobile && (
                            <p className="text-red-600 text-xs py-5 pl-3 ">
                              {errors.mobile}
                            </p>
                          )}
                        </div>
                        ...
                        <div className="flex flex-col">
                          ...
                          <Input
                            id="mobileVerified"
                            className=" rounded-none h-5 w-5 ml-3 mt-2"
                            type="checkbox"
                            ...
                            onChange={(e) => {
                              setFormData((prevData) => ({
                                ...prevData,
                                mobileVerified: e.target.checked,
                              }));
                              validateTab1();
                            }}
                          />
                          {errors.mobileVerifiedError && (
                            <p className="text-red-600 text-xs py-5 pl-3 ">
                              {errors.mobileVerifiedError}
                            </p>
                          )}
                    ...
                    <div className="p-2">
                      <div className="grid gap-2 lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 pb-5 ">
                        <div className="flex flex-col">
                          ...
                          <Dropdown
                            ...
                            onChange={(e: DropdownChangeEvent) =>
                              handleVerifyShopSelect(e.value)
                            }
                            options={verifyShops}
                            optionLabel="name"
                        ...
                        <div className="flex flex-col">
                          ...
                          <FileUploadMain
                            onFileUpload={(data) =>
                              handleFileUpload(data, "gstCertificate")
                            }
                      ...
                      <div className="grid gap-2 lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 pb-5 ">
                        <div className="flex flex-col">
                          ...
                          <FileUploadMain
                            onFileUpload={(data) =>
                              handleFileUpload(data, "photoShopFront")
                            }
                            uploadFunction={uploadAppUser}
                            downloadFunction={downloadFileAppUser}
                            multiple={true}
                        ...
                        <div className="flex flex-col">
                          ...
                          <FileUploadMain
                            onFileUpload={(data) =>
                              handleFileUpload(data, "visitingCard")
                            }
                            uploadFunction={uploadAppUser}
                            downloadFunction={downloadFileAppUser}
                            multiple={true}
                      ...
                      <div className="grid gap-2 lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 pb-5 ">
                        <div className="flex flex-col">
                          ...
                          <Input
                            id="hasImpersonateAccess"
                            className=" rounded-none h-5 w-5 ml-3 mt-2"
                            type="checkbox"
                            placeholder="Has Impersonate Access"
                            name="hasImpersonateAccess"
                            checked={formData.hasImpersonateAccess}
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                hasImpersonateAccess: e.target.checked,
                              })
                            }
                          />
                        </div>
                        ...
                        <div className="flex flex-col">
                          ...
                          <FileUploadMain
                            onFileUpload={(data) =>
                              handleFileUpload(data, "photoAttachment")
                            }
                            uploadFunction={uploadAppUser}
                            downloadFunction={downloadFileAppUser}
                            multiple={true}
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className=" flex flex-col justify-center items-center w-[350px]">
          <DialogHeader>
            <DialogTitle>
              <Image
                src="https://diw.wazl.in/assets/images/popups/update.jpg"
                alt="Update Image"
                width={100}
                height={100}
              />
